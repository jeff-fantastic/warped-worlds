...
#define SOUND_MARIO_HERE_WE_GO                   /* 0x240C8080 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x0C, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
...
#define SOUND_ENV_STAR                           /* 0x40140010 */ SOUND_ARG_LOAD(SOUND_BANK_ENV,      0x14, 0x80, SOUND_LOWER_BACKGROUND_MUSIC) // unverified
...
#define SOUND_ENV_CHOIR                                           SOUND_ARG_LOAD(SOUND_BANK_ENV,      0x28, 0x80, 0)
#define SOUND_ENV_MEAT                                            SOUND_ARG_LOAD(SOUND_BANK_ENV,      0x29, 0x80, 0)
...
#define SOUND_OBJ_HEART_BEAT                                      SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x7F, 0x80, SOUND_DISCRETE)
...
#define SOUND_AIR_HEART                                           SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x23, 0x40, 0)
#define SOUND_AIR_SHORE                                           SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x24, 0x40, 0)
...
#define SOUND_MENU_STAR_SOUND                    /* 0x701EFF80 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x1E, 0xFE, SOUND_DISCRETE)
