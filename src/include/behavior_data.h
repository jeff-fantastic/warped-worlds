...
extern const BehaviorScript bhvSpinningCog[];
extern const BehaviorScript bhvRedGoomba[];
extern const BehaviorScript bhvKoopaKid[];
extern const BehaviorScript bhvPrince[];
extern const BehaviorScript bhvBobTiltingInvertedPyramid[];
extern const BehaviorScript bhvStackOfBooks[];
extern const BehaviorScript bhvHeart[];
extern const BehaviorScript bhvHeartClock[];
extern const BehaviorScript bhvStarDust[];
extern const BehaviorScript bhvLFWoodPlatform[];
extern const BehaviorScript bhvWaterbed[];
extern const BehaviorScript bhvBobbingPlatform[];
extern const BehaviorScript bhvWeakScaffold[];
extern const BehaviorScript bhvN64Logo[];
extern const BehaviorScript bhvWhompShockWave[];
