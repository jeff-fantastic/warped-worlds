...
enum SeqId {
    ...
    SEQ_FLYING_FORTRESS,              // 0x23
    SEQ_DREAMING_OF_SOMETHING,        // 0x24
    SEQ_LEVEL_DEPRESSED_CASTLE,       // 0x25
    SEQ_LEVEL_THIS_PLACE,             // 0x26
    SEQ_LEVEL_PINK_RAIN,              // 0x27
    SEQ_HPC_TITLE_SCREEN,             // 0x28
    SEQ_MEADOW,                       // 0x29
    SEQ_YOU,                          // 0x2A
    SEQ_BOB_BOSS,                     // 0x2B
    SEQ_INDEFINITE_LAKE,              // 0x2C
    SEQ_STREAMED_STAR_SELECT,         // 0x2D
    SEQ_HIS_DOMAIN_ALT,               // 0x2E
    SEQ_LEGACY_FORTRESS,              // 0x2F
    SEQ_STREAMED_HELL_AMBIANCE,       // 0x30
    SEQ_ERROR_HANDLER,                // 0x31
    SEQ_COUNT
};
