COURSE_ACTS(COURSE_BOB, _(" 1 DAFFODIL MEADOW"),
       _("BRAWL WITH THE DEADLY PRINCE")     , _("LITTLE KOOPA QUEST") , _("SCATTERED 8 REDS IN THE MEADOW"),
       _("TOPPLING TOWER IN THE SKY")          , _("WORLD BEHIND THE WATERFALL")        , _("TUMBLING ROCKS IN THE FALL"))

COURSE_ACTS(COURSE_WF, _(" 2 FLYING FORTRESS"),
       _("MEETING WITH THE KING")        , _("HUNTING FOR 8 RED COINS")    , _("ATOP THE FLOATING ISLE"),
       _("FROLIC IN THE FLOWERS"), _("THE INTERNAL FORTRESS")    , _("REVISITING THE KING"))
...
SECRET_STAR(COURSE_SA, _("    DANCING IN THE LIGHTS"))
