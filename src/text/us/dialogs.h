...
pipsqueak? Did that\n\
stupid turtle tell you\n\
to come up here? On\n\
MY mountain?\n\
Fueh fueh fueh...\n\
It's a mistake to try\n\
and challenge me, the\n\
prince of this mystical\n\
world.\n\
\n\
Not even that Koopa king\n\
wants to get in a brawl\n\
with ME! You're quite\n\
brave trying to challenge\n\
someone so strong...\n\
\n\
Oh well, let this be\n\
known as the day I crush\n\
yet another hopeless\n\
fool. Say your prayers."))
...
DEFINE_DIALOG(DIALOG_111, 1, 4, 30, 200, _("\
\n\
 !!   MESSAGE TO ALL   !!\n\
 !!       TROOPS       !!\n\
\n\
...
have thought out this\n\
design more.\n\
\n\
My fortress is to your\n\
left, feel free to always\n\
pay a visit!\n\
\n\
/--King Whomp\n\
"))
...
Mario? What are you\n\
doing here? You haven't\n\
visited the fortress in a\n\
while. Not sure if you\n\
knew this, but...\n\
The Koopa King has\n\
taken over. I'm sorry\n\
Mario, but I must follow\n\
his strict orders."))
...
DEFINE_DIALOG(DIALOG_168, 1, 3, 95, 200, _("\
Yow! Watch out buddy!\n\
The water up there is\n\
hot-hot-HOT!\n\
Try and avoid it at\n\
all costs!"))
...
Welcome to Flying\n\
Fortress, where the\n\
lushious nature grows\n\
and the whomps\n\
prosper!\n\
If you've ever wanted to\n\
see beautiful flowers\n\
and trees, you're in the\n\
right place!\n\
\n\
Come and visit the\n\
tower and talk with\n\
the King, he is always\n\
willing to give tours!\n\
"))

DEFINE_DIALOG(DIALOG_170, 1, 6, 30, 200, _("\
The AI mode is a special\n\
mode that enables unique\n\
events and occurences\n\
throughout the game.\n\
This mode makes every\n\
playthrough different\n\
with events that change\n\
many values, like levels\n\
and gameplay.\n\
\n\
We advise if you are \n\
going to be speedrunning\n\
His Personalized Copy,\n\
you should turn this\n\
setting off.\n\
\n\
This will disable ALL\n\
random events, blocking\n\
an 100 percent save file,\n\
but allowing the game to\n\
be played from beginning\n\
to end on a set route,\n\
with no random\n\
interactions.\n\
\n\
//ENABLE//DISABLE"))
...
that looks as pretty as\n\
this one before? Such a\n\
lovely place to be!"))

DEFINE_DIALOG(DIALOG_172, 1, 4, 30, 200, _("\
Are you the person that\n\
defused the Prince up\n\
there?\n\
\n\
Oh gee, thank you so\n\
much! He's been a real\n\
nuisance to me and my\n\
family...\n\
...
that mountain until\n\
the angry Prince\n\
stomped me outta there.\n\
I ran as hard as I\n\
could! I felt like\n\
my legs were gonna\n\
fall off!!\n\
I lost one of my book\n\
stacks running down\n\
though, and I need it\n\
to finish the cannon.\n\
Could you please help\n\
me? You seem very fit\n\
for this job...\n\
"))
...
take this shiny star of\n\
mine. You seem to need\n\
it more than me!"))

DEFINE_DIALOG(DIALOG_174, 1, 1, 30, 200, _("\
Thank you!"))

DEFINE_DIALOG(DIALOG_175, 1, 4, 30, 200, _("\
Hello there! I still feel\n\
really bad about the\n\
fight earlier, I hope\n\
you can forgive me.\n\
Have you seen that\n\
little koopa anywhere?\n\
The one with the\n\
glasses...\n\
I came down here to\n\
apologize to him, I\n\
...
DEFINE_DIALOG(DIALOG_176, 1, 5, 30, 200, _("\
Message from the Koopa\n\
Krew to you:\n\
Please do not precisely\n\
throw a bomb at this\n\
fragile wall! Thanks."))
