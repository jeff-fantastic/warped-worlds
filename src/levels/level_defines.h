...
DEFINE_LEVEL("SELECT ROOM", LEVEL_CASTLE, COURSE_NONE, castle_inside, inside, 20000, 0x30, 0x30, 0x00, _, sCamCastle) 
...
DEFINE_LEVEL("BATTLE FIELD", LEVEL_BOB, COURSE_BOB, bob, generic, 20000, 0x00, 0x40, 0x00, _, sCamBOB) 
...
DEFINE_LEVEL("MOUNTAIN", LEVEL_WF, COURSE_WF, wf, grass, 20000, 0x00, 0x05, 0x40, _, sCamWF) 
...
DEFINE_LEVEL("EXT6 MARIO FLY", LEVEL_TOTWC, COURSE_TOTWC, totwc, sky, 20000, 0x30, 0x00, 0x00, _, sCamTotWC) 
