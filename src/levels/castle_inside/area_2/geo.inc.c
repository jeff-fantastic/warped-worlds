...
const GeoLayout castle_inside_area_2_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_ALPHA, castle_inside_dl_SketchUp_001_mesh),
		GEO_TRANSLATE_NODE(LAYER_ALPHA, 3464, 448, -334),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT, castle_inside_dl_SketchUp_016_mesh),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, castle_inside_dl_SketchUp_025_mesh),
