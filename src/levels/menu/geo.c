...
const GeoLayout geo_menu_act_selector_strings[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         ...
         GEO_OPEN_NODE(),
            GEO_CAMERA(0, 0, -300, 1600, 0, -650, 0, 0x00000000),
            GEO_OPEN_NODE(),
               GEO_RENDER_OBJ(),
            GEO_CLOSE_NODE(),
         GEO_CLOSE_NODE(),
...
const GeoLayout geo_background[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_ALPHA, titlehpc_Plane_mesh),
		GEO_DISPLAY_LIST(LAYER_ALPHA, titlehpc_material_revert_render_settings),
	GEO_CLOSE_NODE(),
	GEO_END(),
};

const GeoLayout geo_cloud_back[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_ALPHA, titlehpc_cback_Plane_001_mesh),
		GEO_DISPLAY_LIST(LAYER_ALPHA, titlehpccback_material_revert_render_settings),
	GEO_CLOSE_NODE(),
	GEO_END(),
};

const GeoLayout geo_cloud_middle[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_ALPHA, titlehpc_cmiddle_Plane_002_mesh),
		GEO_DISPLAY_LIST(LAYER_ALPHA, titlehpccmiddle_material_revert_render_settings),
	GEO_CLOSE_NODE(),
	GEO_END(),
};

const GeoLayout geo_cloud_front[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_ALPHA, titlehpc_cfront_Plane_003_mesh),
		GEO_DISPLAY_LIST(LAYER_ALPHA, titlehpccfront_material_revert_render_settings),
	GEO_CLOSE_NODE(),
	GEO_END(),
};
