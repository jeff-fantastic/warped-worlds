...
#include "types.h"
#include "levels/menu/texscroll.inc.h"
...
Lights1 titlehpc_sm64_material_001_v3_001_layer4_lights = gdSPDefLights1(
	0x7F, 0x7F, 0x7F,
	0xFE, 0xFE, 0xFE, 0x28, 0x28, 0x28);

Gfx titlehpc_CloudTile_ia4_aligner[] = {gsSPEndDisplayList()};
u8 titlehpc_CloudTile_ia4[] = {
...
Vtx titlehpc_Plane_mesh_vtx_0[4] = {
	{{{-1051, 789, -189},0, {-16, 1008},{0x29, 0x29, 0x29, 0xFF}}},
	{{{1051, 789, -189},0, {1008, 1008},{0x29, 0x29, 0x29, 0xFF}}},
	{{{1051, -789, -189},0, {1008, -16},{0x0, 0x0, 0x0, 0xFF}}},
	{{{-1051, -789, -189},0, {-16, -16},{0x0, 0x0, 0x0, 0xFF}}},
};

Gfx titlehpc_Plane_mesh_tri_0[] = {
	gsSPVertex(titlehpc_Plane_mesh_vtx_0 + 0, 4, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 2, 3, 0),
	gsSPEndDisplayList(),
};

Vtx titlehpc_Plane_mesh_vtx_1[4] = {
	{{{-816, 183, -520},0, {-6144, -100},{0x0, 0x0, 0x81, 0xFF}}},
	{{{816, 183, -520},0, {10240, -100},{0x0, 0x0, 0x81, 0xFF}}},
	{{{816, -827, -520},0, {10240, 8092},{0x0, 0x0, 0x81, 0xFF}}},
	{{{-816, -827, -520},0, {-6144, 8092},{0x0, 0x0, 0x81, 0xFF}}},
};

Gfx titlehpc_Plane_mesh_tri_1[] = {
	gsSPVertex(titlehpc_Plane_mesh_vtx_1 + 0, 4, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 2, 3, 0),
	gsSPEndDisplayList(),
};

Vtx titlehpc_Plane_mesh_vtx_2[4] = {
	{{{-808, 3, -544},0, {-2048, 322},{0x0, 0x0, 0x81, 0xFF}}},
	{{{808, 3, -544},0, {6144, 322},{0x0, 0x0, 0x81, 0xFF}}},
	{{{808, -827, -544},0, {6144, 4418},{0x0, 0x0, 0x81, 0xFF}}},
	{{{-808, -827, -544},0, {-2048, 4418},{0x0, 0x0, 0x81, 0xFF}}},
};

Gfx titlehpc_Plane_mesh_tri_2[] = {
	gsSPVertex(titlehpc_Plane_mesh_vtx_2 + 0, 4, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 2, 3, 0),
	gsSPEndDisplayList(),
};

Vtx titlehpc_Plane_mesh_vtx_3[4] = {
	{{{-796, -181, -575},0, {0, 381},{0x0, 0x0, 0x81, 0xFF}}},
	{{{796, -181, -575},0, {4096, 381},{0x0, 0x0, 0x81, 0xFF}}},
	{{{796, -1008, -575},0, {4096, 2429},{0x0, 0x0, 0x81, 0xFF}}},
	{{{-796, -1008, -575},0, {0, 2429},{0x0, 0x0, 0x81, 0xFF}}},
};

Gfx titlehpc_Plane_mesh_tri_3[] = {
	gsSPVertex(titlehpc_Plane_mesh_vtx_3 + 0, 4, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 2, 3, 0),
	gsSPEndDisplayList(),
};
...
Gfx mat_titlehpc_sm64_material_001_v3_001_layer4[] = {
	gsDPPipeSync(),
	...
	gsSPSetLights1(titlehpc_sm64_material_001_v3_001_layer4_lights),
	gsSPEndDisplayList(),
};

Gfx mat_revert_titlehpc_sm64_material_001_v3_001_layer4[] = {
	gsDPPipeSync(),
...
Gfx mat_titlehpc_sm64_material_002[] = {
	gsDPPipeSync(),
	...
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsDPTileSync(),
	gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_8b, 64, titlehpc_CloudTile_ia4),
...
Gfx mat_revert_titlehpc_sm64_material_002[] = {
	gsDPPipeSync(),
...
Gfx mat_titlehpc_sm64_material_001[] = {
	gsDPPipeSync(),
	gsDPSetCombineLERP(TEXEL0, 0, PRIMITIVE, 0, TEXEL0, 0, ENVIRONMENT, 0, TEXEL0, 0, PRIMITIVE, 0, TEXEL0, 0, ENVIRONMENT, 0),
	gsSPClearGeometryMode(G_CULL_BACK),
	gsDPSetTextureFilter(G_TF_POINT),
...
Gfx mat_revert_titlehpc_sm64_material_001[] = {
	gsDPPipeSync(),
	gsSPSetGeometryMode(G_CULL_BACK),
	gsDPSetTextureFilter(G_TF_BILERP),
	gsSPEndDisplayList(),
...
Gfx mat_titlehpc_sm64_material[] = {
	gsDPPipeSync(),
...
Gfx mat_revert_titlehpc_sm64_material[] = {
	gsDPPipeSync(),
	gsSPSetGeometryMode(G_CULL_BACK),
	gsDPSetTextureFilter(G_TF_BILERP),
	gsSPEndDisplayList(),
...
Gfx titlehpc_Plane_mesh[] = {
	gsSPDisplayList(mat_titlehpc_sm64_material_001_v3_001_layer4),
	gsSPDisplayList(titlehpc_Plane_mesh_tri_0),
	gsSPDisplayList(mat_revert_titlehpc_sm64_material_001_v3_001_layer4),
	gsSPDisplayList(mat_titlehpc_sm64_material_002),
	gsSPDisplayList(titlehpc_Plane_mesh_tri_1),
	gsSPDisplayList(mat_revert_titlehpc_sm64_material_002),
	gsSPDisplayList(mat_titlehpc_sm64_material_001),
	gsSPDisplayList(titlehpc_Plane_mesh_tri_2),
	gsSPDisplayList(mat_revert_titlehpc_sm64_material_001),
	gsSPDisplayList(mat_titlehpc_sm64_material),
	gsSPDisplayList(titlehpc_Plane_mesh_tri_3),
	gsSPDisplayList(mat_revert_titlehpc_sm64_material),
	gsSPEndDisplayList(),
};

Gfx titlehpc_material_revert_render_settings[] = {
	gsDPPipeSync(),
	gsSPSetGeometryMode(G_LIGHTING),
...
Gfx titlehpc_cback_CloudTile_ia4_aligner[] = {gsSPEndDisplayList()};
u8 titlehpc_cback_CloudTile_ia4[] = {
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
...
Vtx titlehpc_cback_Plane_001_mesh_vtx_0[4] = {
	{{{-816, 76, -667},0, {-6160, -116},{0x0, 0x0, 0x81, 0xFF}}},
	{{{816, 76, -667},0, {10224, -116},{0x0, 0x0, 0x81, 0xFF}}},
	{{{816, -934, -667},0, {10224, 8076},{0x0, 0x0, 0x81, 0xFF}}},
	{{{-816, -934, -667},0, {-6160, 8076},{0x0, 0x0, 0x81, 0xFF}}},
};

Gfx titlehpc_cback_Plane_001_mesh_tri_0[] = {
	gsSPVertex(titlehpc_cback_Plane_001_mesh_vtx_0 + 0, 4, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 2, 3, 0),
	gsSPEndDisplayList(),
};
...
Gfx mat_titlehpccback_sm64_material_002[] = {
	gsDPPipeSync(),
	gsDPSetCombineLERP(TEXEL0, 0, PRIMITIVE, 0, TEXEL0, 0, ENVIRONMENT, 0, TEXEL0, 0, PRIMITIVE, 0, TEXEL0, 0, ENVIRONMENT, 0),
	gsSPClearGeometryMode(G_CULL_BACK),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsDPTileSync(),
	gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_8b, 64, titlehpc_cback_CloudTile_ia4),
	gsDPSetTile(G_IM_FMT_IA, G_IM_SIZ_8b, 8, 0, 7, 0, G_TX_CLAMP | G_TX_NOMIRROR, 6, 0, G_TX_WRAP | G_TX_NOMIRROR, 7, 0),
	gsDPLoadSync(),
	gsDPLoadTile(7, 0, 0, 254, 252),
	gsDPPipeSync(),
...
Gfx mat_revert_titlehpccback_sm64_material_002[] = {
	gsDPPipeSync(),
	gsSPSetGeometryMode(G_CULL_BACK),
	gsSPEndDisplayList(),
};

Gfx titlehpc_cback_Plane_001_mesh[] = {
	gsSPDisplayList(mat_titlehpccback_sm64_material_002),
	gsSPDisplayList(titlehpc_cback_Plane_001_mesh_tri_0),
	gsSPDisplayList(mat_revert_titlehpccback_sm64_material_002),
	gsSPEndDisplayList(),
};

Gfx titlehpccback_material_revert_render_settings[] = {
	gsDPPipeSync(),
	gsSPSetGeometryMode(G_LIGHTING),
	gsSPClearGeometryMode(G_TEXTURE_GEN),
	gsDPSetCombineLERP(0, 0, 0, SHADE, 0, 0, 0, ENVIRONMENT, 0, 0, 0, SHADE, 0, 0, 0, ENVIRONMENT),
...
Gfx titlehpc_cfront_CloudTile_ia4_aligner[] = {gsSPEndDisplayList()};
u8 titlehpc_cfront_CloudTile_ia4[] = {
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
...
Vtx titlehpc_cfront_Plane_003_mesh_vtx_0[4] = {
	{{{-796, -287, -722},0, {-16, 365},{0x0, 0x0, 0x81, 0xFF}}},
	{{{796, -287, -722},0, {4080, 365},{0x0, 0x0, 0x81, 0xFF}}},
	{{{796, -1114, -722},0, {4080, 2413},{0x0, 0x0, 0x81, 0xFF}}},
	{{{-796, -1114, -722},0, {-16, 2413},{0x0, 0x0, 0x81, 0xFF}}},
};

Gfx titlehpc_cfront_Plane_003_mesh_tri_0[] = {
	gsSPVertex(titlehpc_cfront_Plane_003_mesh_vtx_0 + 0, 4, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 2, 3, 0),
	gsSPEndDisplayList(),
};
...
Gfx mat_titlehpccfront_sm64_material[] = {
	gsDPPipeSync(),
	gsDPSetCombineLERP(0, 0, 0, TEXEL0, TEXEL0, 0, ENVIRONMENT, 0, 0, 0, 0, TEXEL0, TEXEL0, 0, ENVIRONMENT, 0),
	gsSPClearGeometryMode(G_CULL_BACK),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsDPTileSync(),
	gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_8b, 64, titlehpc_cfront_CloudTile_ia4),
	gsDPSetTile(G_IM_FMT_IA, G_IM_SIZ_8b, 8, 0, 7, 0, G_TX_CLAMP | G_TX_NOMIRROR, 6, 0, G_TX_WRAP | G_TX_NOMIRROR, 7, 0),
	gsDPLoadSync(),
	gsDPLoadTile(7, 0, 0, 254, 252),
	gsDPPipeSync(),
...
Gfx mat_revert_titlehpccfront_sm64_material[] = {
	gsDPPipeSync(),
	gsSPSetGeometryMode(G_CULL_BACK),
	gsSPEndDisplayList(),
};

Gfx titlehpc_cfront_Plane_003_mesh[] = {
	gsSPDisplayList(mat_titlehpccfront_sm64_material),
	gsSPDisplayList(titlehpc_cfront_Plane_003_mesh_tri_0),
	gsSPDisplayList(mat_revert_titlehpccfront_sm64_material),
	gsSPEndDisplayList(),
};

Gfx titlehpccfront_material_revert_render_settings[] = {
	gsDPPipeSync(),
	gsSPSetGeometryMode(G_LIGHTING),
	gsSPClearGeometryMode(G_TEXTURE_GEN),
	gsDPSetCombineLERP(0, 0, 0, SHADE, 0, 0, 0, ENVIRONMENT, 0, 0, 0, SHADE, 0, 0, 0, ENVIRONMENT),
...
Gfx titlehpc_cmiddle_CloudTile_ia4_aligner[] = {gsSPEndDisplayList()};
u8 titlehpc_cmiddle_CloudTile_ia4[] = {
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
...
Vtx titlehpc_cmiddle_Plane_002_mesh_vtx_0[4] = {
	{{{-808, -103, -691},0, {-2064, 306},{0x0, 0x0, 0x81, 0xFF}}},
	{{{808, -103, -691},0, {6128, 306},{0x0, 0x0, 0x81, 0xFF}}},
	{{{808, -934, -691},0, {6128, 4402},{0x0, 0x0, 0x81, 0xFF}}},
	{{{-808, -934, -691},0, {-2064, 4402},{0x0, 0x0, 0x81, 0xFF}}},
};

Gfx titlehpc_cmiddle_Plane_002_mesh_tri_0[] = {
	gsSPVertex(titlehpc_cmiddle_Plane_002_mesh_vtx_0 + 0, 4, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 2, 3, 0),
	gsSPEndDisplayList(),
};
...
Gfx mat_titlehpccmiddle_sm64_material_001[] = {
	gsDPPipeSync(),
	gsDPSetCombineLERP(TEXEL0, 0, PRIMITIVE, 0, TEXEL0, 0, ENVIRONMENT, 0, TEXEL0, 0, PRIMITIVE, 0, TEXEL0, 0, ENVIRONMENT, 0),
	gsSPClearGeometryMode(G_CULL_BACK),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsDPTileSync(),
	gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_8b, 64, titlehpc_cmiddle_CloudTile_ia4),
	gsDPSetTile(G_IM_FMT_IA, G_IM_SIZ_8b, 8, 0, 7, 0, G_TX_CLAMP | G_TX_NOMIRROR, 6, 0, G_TX_WRAP | G_TX_NOMIRROR, 7, 0),
	gsDPLoadSync(),
	gsDPLoadTile(7, 0, 0, 254, 252),
	gsDPPipeSync(),
...
Gfx mat_revert_titlehpccmiddle_sm64_material_001[] = {
	gsDPPipeSync(),
	gsSPSetGeometryMode(G_CULL_BACK),
	gsSPEndDisplayList(),
};

Gfx titlehpc_cmiddle_Plane_002_mesh[] = {
	gsSPDisplayList(mat_titlehpccmiddle_sm64_material_001),
	gsSPDisplayList(titlehpc_cmiddle_Plane_002_mesh_tri_0),
	gsSPDisplayList(mat_revert_titlehpccmiddle_sm64_material_001),
	gsSPEndDisplayList(),
};

Gfx titlehpccmiddle_material_revert_render_settings[] = {
	gsDPPipeSync(),
	gsSPSetGeometryMode(G_LIGHTING),
	gsSPClearGeometryMode(G_TEXTURE_GEN),
	gsDPSetCombineLERP(0, 0, 0, SHADE, 0, 0, 0, ENVIRONMENT, 0, 0, 0, SHADE, 0, 0, 0, ENVIRONMENT),
