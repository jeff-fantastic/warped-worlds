...
sound_ref .sound_env_waterfall1
sound_ref .sound_env_waterfall1
sound_ref .sound_air_choir
sound_ref .sound_env_meat
...
sound_ref .sound_obj_bowser_tail_pickup
sound_ref .sound_obj_bowser_defeated
sound_ref .sound_obj_heart_beat
...
sound_ref .sound_air_bowser_spit_fire
sound_ref .sound_air_bowser_spit_fire
sound_ref .sound_air_static
sound_ref .sound_air_fire
sound_ref .sound_air_dark
sound_ref .sound_air_heart
sound_ref .sound_air_shore
...
chan_setbank 5
chan_setinstr 16
chan_setlayer 0, .layer_air_static
chan_end

.layer_air_static:
layer_note1 39, 0xD2, 110
layer_end

.sound_air_fire:
chan_setbank 5
chan_setinstr 17
chan_setlayer 0, .layer_air_fire
chan_end

.layer_air_fire:
layer_note1 39, 0x63, 110
layer_end

.sound_air_dark:
chan_setbank 5
chan_setinstr 18
chan_setlayer 0, .layer_air_dark
chan_end
...
chan_setbank 5
chan_setinstr 20
chan_setlayer 0, .layer_air_heart
chan_end

.layer_air_heart:
layer_note1 35, 0x0412, 110
layer_end

.sound_obj_heart_beat:
chan_setbank 5
chan_setinstr 19
chan_setlayer 0, .layer_obj_heart_beat
chan_end

.layer_obj_heart_beat:
...
chan_setbank 5
chan_setinstr 21
chan_setlayer 0, .layer_air_shore
chan_end

.layer_air_shore:
layer_note1 38, 0x1B0, 127
layer_end

.sound_air_choir:
chan_setbank 5
chan_setinstr 22
chan_setlayer 0, .layer_air_choir
chan_end

.layer_air_choir:
layer_note1 10, 0xC4E, 127

.sound_env_meat:
chan_setbank 5
chan_setinstr 23
chan_setlayer 0, .layer_env_meat
chan_end

.layer_env_meat:
layer_note1 38, 0x1B0, 80
layer_end