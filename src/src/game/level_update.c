...
// Play the bowser laughter sound.
s32 lvl_play_bowser_laughter(UNUSED s16 arg0, UNUSED s32 arg1) {
    play_sound(SOUND_MENU_BOWSER_LAUGH, gGlobalSoundSource);
    return 1;
}

// Play the pipe entrance sound.
s32 lvl_play_enter_pipe(UNUSED s16 arg0, UNUSED s32 arg1) {
