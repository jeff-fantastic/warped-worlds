...
// AI MODE SEED GEN SYSTEM BY JEFFREY M. 25-02-2020 //

/* The first value in the seed array is one generated when you enter into a save file at any   */
/* moment. That is the only time it changes and it effects major RNG events in the game.       */
/* The second value in the seed array is the RNG1 value that gets changed whenever any inputs  */
/* are made on the controller.                                                                 */
/* The third value in the seed array is the RNG2 value that gets changed whenever any          */
/* interactions occur between mario and an object                                              */
/* The fourth value in the seed array is the RNG3 value that gets changed whenever a star      */
/* is collected.                                                                               */

u16 aiModeSeed[] = { 0, 0, 0, 0 };
