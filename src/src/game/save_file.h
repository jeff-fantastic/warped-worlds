...
struct SaveFile
{
    ...
    // Flags ticked on and off based on ingame happenings
    u32 flags;
...
u16 save_file_return_ai_seed2(void);
u16 save_file_return_ai_seed3(void);
u16 save_file_return_ai_seed4(void);
