...
static void print_file_select_strings(void) {
    ...
    if (menuLayer == 0) {
        ...
        switch (menuIndex) {
            case 0:
                print_text_centered(160, 90, "- START GAME -");
                print_text_centered(160, 72,  "OPTIONS");
                print_text_centered(160, 54,  "JUKEBO*");
                print_text_centered(160, 36,  "E*TRAS");
                break;
            case 1:
                print_text_centered(160, 90, "START GAME");
                print_text_centered(160, 72,  "- OPTIONS -");
        ...
        switch (menuIndex) {
            case 0:
                print_text(80, 90, "- FILE1");
                print_text(80, 72,  "  FILE2");
                print_text_centered(160, 54,  "ERASE FILE");
                print_text_centered(160, 36,  "GO BACK");
                break;
            case 1:
                print_text(80, 90, "  FILE1");
                print_text(80, 72,  "- FILE2");
        ...
        print_save_file_star_count(SAVE_FILE_A, 174, 90);
        print_save_file_star_count(SAVE_FILE_C, 174, 72);
        ...
        switch (menuIndex) {
            case 0:
                print_text(80, 90, "- FILE1");
                print_text(80, 72,  "  FILE2");
                print_text_centered(160, 54,  "GO BACK");
                break;
            case 1:
                print_text(80, 90, "  FILE1");
                print_text(80, 72,  "- FILE2");
        ...
        switch (menuIndex) {
            case 0:
                print_text_centered(160, 90, "- AI MODE -");
                print_text_centered(160, 54, "GO BACK");
                if (sSoundMode == 0) {
                    print_text_centered(160, 72, "SOUND STEREO");
                } else if (sSoundMode == 3) {
                    print_text_centered(160, 72, "SOUND MONO");
                }
                break;
            case 1:
                print_text_centered(160, 90, "AI MODE");
        ...
        switch (menuIndex) {
            case 0:
                print_text_fmt_int(124, 80, "- %02d -", musicArray[musicIndex] - 34);
                print_text_centered(160, 60, "GO BACK");
                break;
            case 1:
                print_text_fmt_int(124, 80, "  %02d", musicArray[musicIndex] - 34);
                print_text_centered(160, 60, "- GO BACK -");
        ...
        print_text_centered(160, 100, "JUKEBO*");
        jukebox_control();
    } else if (menuLayer == 5) {
        menuIndexMax = 1;
        ...
        switch (menuIndex) {
            case 0:
                print_text_centered(160, 90, "- LEGACY FORTRESS -");
                print_text_centered(160, 72, "GO BACK");
                break;
            case 1:
                print_text_centered(160, 90, "LEGACY FORTRESS");
                print_text_centered(160, 72, "- GO BACK -");
