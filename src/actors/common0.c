...
#include "goombared/model.inc.c"
#include "goombared/anims/data.inc.c"
#include "goombared/anims/table.inc.c"
#include "woodenplatform/model.inc.c"
#include "woodenplatform/collision.inc.c"
