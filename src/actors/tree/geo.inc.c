...
// 0x16001060
const GeoLayout grayscale_bubbly_tree_geo[] = {
	GEO_CULLING_RADIUS(1600),
	GEO_OPEN_NODE(),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_ALPHA, tree_000_displaylist_mesh),
		GEO_CLOSE_NODE(),
...
const GeoLayout meadow_bubbly_tree_geo[] = {
	GEO_CULLING_RADIUS(800),
	GEO_OPEN_NODE(),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_ALPHA, meadowtree_000_displaylist_mesh),
		GEO_CLOSE_NODE(),
		GEO_DISPLAY_LIST(LAYER_ALPHA, meadowtree_material_revert_render_settings),
	GEO_CLOSE_NODE(),
	GEO_END(),
};
