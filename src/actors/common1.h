...
extern const GeoLayout grayscale_door_geo[];
extern Vtx door_000_offset_001_mesh_vtx_0[16];
extern Gfx door_000_offset_001_mesh_tri_0[];
extern Vtx door_000_offset_001_mesh_vtx_1[8];
extern Gfx door_000_offset_001_mesh_tri_1[];
extern Vtx door_000_offset_001_mesh_vtx_2[28];
extern Gfx door_000_offset_001_mesh_tri_2[];
extern Gfx door_000_offset_001_mesh[];
...
extern const GeoLayout grayscale_leaves_geo[];
extern const Gfx grayscale_leaves_seg3_dl_0301CDE0[];
...
extern const Gfx star_coin1_txt[];
extern const Gfx star_coin2_txt[];
extern const Gfx star_coin3_txt[];
extern const Gfx star_coin4_txt[];
extern const Gfx star_coin5_txt[];
extern const Gfx star_coin6_txt[];
extern const Gfx star_coin7_txt[];
extern const Gfx star_coin8_txt[];
...
// key
extern const GeoLayout key_geo[];
extern const Gfx key_coin1_txt[];
extern const Gfx key_coin2_txt[];
extern const Gfx key_coin3_txt[];
extern const Gfx key_coin4_txt[];
extern const Gfx key_coin5_txt[];
extern const Gfx key_coin6_txt[];
extern const Gfx key_coin7_txt[];
extern const Gfx key_coin8_txt[];
extern const Gfx key_coin9_txt[];
extern const Gfx key_coin10_txt[];
extern const Gfx key_coin11_txt[];
extern const Gfx key_coin12_txt[];
extern const Gfx key_coin13_txt[];
extern const Gfx key_coin14_txt[];
extern const Gfx key_coin15_txt[];
extern const Gfx key_coin16_txt[];

// transparent_star
extern const GeoLayout transparent_star_geo[];
extern const Gfx transparent_star_seg3_dl_0302C560[];
extern const Gfx transparent_star_seg3_dl_0[];
extern const Gfx transparent_star_seg3_dl_1[];
extern const Gfx transparent_star_seg3_dl_2[];
extern const Gfx transparent_star_seg3_dl_3[];
extern const Gfx transparent_star_seg3_dl_4[];
extern const Gfx transparent_star_seg3_dl_5[];
extern const Gfx transparent_star_seg3_dl_6[];
extern const Gfx transparent_star_seg3_dl_7[];
...
extern const GeoLayout grayscale_bubbly_tree_geo[];
extern Vtx tree_000_displaylist_mesh_vtx_0[3];
extern Gfx tree_000_displaylist_mesh_tri_0[];
extern Vtx tree_000_displaylist_mesh_vtx_1[3];
...
extern const GeoLayout meadow_bubbly_tree_geo[];
extern Lights1 meadowtree_TreeLeft_001_lights;
extern Lights1 meadowtree_TreeRight_002_lights;
extern u8 meadowtree_tree_left_side_rgba16_rgba16[];
extern u8 meadowtree_tree_right_side_rgba16_rgba16[];
extern Vtx meadowtree_000_displaylist_mesh_vtx_0[3];
extern Gfx meadowtree_000_displaylist_mesh_tri_0[];
extern Vtx meadowtree_000_displaylist_mesh_vtx_1[3];
extern Gfx meadowtree_000_displaylist_mesh_tri_1[];
extern Gfx mat_meadowtree_TreeLeft_001[];
extern Gfx mat_revert_meadowtree_TreeLeft_001[];
extern Gfx mat_meadowtree_TreeRight_002[];
extern Gfx mat_revert_meadowtree_TreeRight_002[];
extern Gfx meadowtree_000_displaylist_mesh[];
extern Gfx meadowtree_material_revert_render_settings[];
...
#include "spinning_cog/geo_header.h"

#include "spinning_cog/collision_header.h"

#include "title/geo_header.h"

#include "koopakid/geo_header.h"

#include "koopakid/anim_header.h"
#include "prince_bobomb/geo_header.h"

#include "prince_bobomb/anim_header.h"
#include "tumbling_platform/geo_header.h"

#include "tumbling_platform/collision_header.h"

#include "goombablue/geo_header.h"

#include "koopa_cannon/geo_header.h"

#include "bookstack/geo_header.h"

#include "crewmate/geo_header.h"

#include "prince_bobomb2/geo_header.h"

#include "evilheart/geo_header.h"

#include "heart_clockhand/geo_header.h"

#include "waterbed/geo_header.h"

#include "weakscaffold/geo_header.h"

#include "weakscaffold/collision_header.h"

#include "n64/geo_header.h"
